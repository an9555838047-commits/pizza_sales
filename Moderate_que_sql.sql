--  Que1->join the necessary tables to find the total quantity of each pizza category ordered
...
<---------------------------------------------------------------------------------------------------------> 
 -- Que2 ->Determine the distribution of orders by hour of the day.
...
--  <---------------------------------------------------------------------------------------------------------------> 
-- Que5 ->Determine the top 3 most ordered pizza types based on revenue
